...
from sqlalchemy import create_engine, text, MetaData, Table, Column, Integer, String, Boolean, DECIMAL, Date, TIMESTAMP, JSON, func
...
class DatabaseLoader:
    ...
    def load_snapshots(
        ...
        logger.info("Starting database load", total_snapshots=len(snapshots), batch_size=batch_size)
    ...
    def cleanup_old_snapshots(self, snapshot_type: str, keep_days: int = 30) -> int:
        ...
        try:
            ...
            logger.info("Cleaned up old snapshots", 
                       snapshot_type=snapshot_type, deleted_count=deleted_count)
