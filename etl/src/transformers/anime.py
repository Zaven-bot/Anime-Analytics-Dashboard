...
from ..models.jikan import JikanAnime, AnimeSnapshot
...
class AnimeTransformer:
    ...
    def transform_anime_list(
        ...
        for anime in anime_list:
            ...
            try:
                ...
                logger.warning("Validation error during transformation", 
                             mal_id=anime.mal_id, title=anime.title, error=str(e))
                ...
                logger.error("Unexpected error during transformation",
                           mal_id=anime.mal_id, title=anime.title, error=str(e))
    ...
    def _clean_text(self, text: Optional[str]) -> Optional[str]:
        ...
        if len(cleaned) > 5000:  # Reasonable limit for synopsis/background
            ...
            logger.debug("Text truncated due to length", original_length=len(text), truncated_length=len(cleaned))
