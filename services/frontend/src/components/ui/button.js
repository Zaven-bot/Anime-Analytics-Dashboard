...
const Button = React.forwardRef(
  ({ className, variant = 'default', size = 'default', ...props }, ref) => {
    const variants = {
      ...
      anime:
        'bg-gradient-to-r from-anime-pink to-anime-purple text-white hover:from-anime-purple hover:to-anime-blue transform hover:scale-105 transition-all duration-300',
    };
