        ...
        <main className="container mx-auto px-4 py-8 space-y-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              Dive into comprehensive analytics covering thousands of anime
              titles, from top-rated classics to upcoming seasonal gems. All
              data is cached and optimized for lightning-fast insights.
            </p>
          </div>
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="text-center">
              ...
              <p className="text-slate-500 text-xs mt-2">
                Dashboard features Redis caching, real-time analytics, and
                responsive design
              </p>
            </div>
          </div>
