            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-800/50 hover:bg-slate-800/50">
                  <TableHead className="text-slate-300 font-semibold w-16">Rank</TableHead>
                  <TableHead className="text-slate-300 font-semibold">Title</TableHead>
                  <TableHead className="text-slate-300 font-semibold w-20 text-center">Score</TableHead>
                  <TableHead className="text-slate-300 font-semibold w-32">Genres</TableHead>
                  <TableHead className="text-slate-300 font-semibold w-32">Studios</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
