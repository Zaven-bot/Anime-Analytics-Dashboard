...
import { TrendingUp, Database, Star, Calendar, RefreshCw, AlertCircle } from 'lucide-react';
...
const OverviewCards = () => {
  ...
  const cards = [
    ...
    {
      title: 'Last Updated',
      value: data.latest_snapshot_date ? new Date(data.latest_snapshot_date).toLocaleDateString() : 'N/A',
