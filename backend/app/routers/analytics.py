...
def get_database_overview():
    ...
    try:
        ...
        snapshot_types = [
            SnapshotTypeInfo(**snapshot_type) 
            for snapshot_type in stats["snapshot_types"]
        ]
...
def get_genre_distribution(
    ...
    try:
        ...
        logger.error("Failed to get genre distribution", error=str(e), snapshot_type=snapshot_type)
